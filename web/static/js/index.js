    ...
    $.ajax({
        ...
        complete: function (r, s) {
            if (s === "success") {
                ...
                for (const d in data) {
                    let html_f = `<tr><td>${data[d]["id"]}</td><td><a href="${data[d]["web_url"]}">${data[d]["web_name"]}</a></td><td><a href="${data[d]["target_url"]}">${data[d]["target_title"]}</a></td><td>${data[d]["target_date"]}</td></tr>`
